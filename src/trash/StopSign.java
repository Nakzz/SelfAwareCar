		...
		if (capture.isOpened()) {
			while (true) {
				...
				if (!webcam_image.empty()) {
					...
					Core.rectangle(webcam_image, new Point(x_centerA, y_centerA), new Point(x_centerB, y_centerB),
							new Scalar(100, 10, 10), 4, 1, 0);
					// This is how u put text
					// Core.putText(webcam_image,String.format("HSV: (" +
					// String.valueOf(a value)),new Point(30, 30) , 3
					// //FONT_HERSHEY_SCRIPT_SIMPLEX
					// ,1.0,new Scalar(100,10,10,255),3);

					Core.putText(webcam_image, String.format("HSV: "), new Point(30, 30), 3, 1.0,
							new Scalar(100, 10, 10, 255), 3);
